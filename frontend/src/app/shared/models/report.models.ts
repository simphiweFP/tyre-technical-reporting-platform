...
export const PHOTO_CATEGORIES = [
  ...
  { key: 'issue2', label: 'Issue 2', hint: 'Another view of the issue', required: true },
  { key: 'bead1', label: 'Bead 1', hint: 'First close-up of bead area', required: true },
  { key: 'bead2', label: 'Bead 2', hint: 'Second close-up of bead area', required: true },
  { key: 'fullView', label: 'Full view', hint: 'Full tyre inspection view', required: true },
  {
    key: 'internalCarcass1',
    label: 'Internal carcass 1',
    hint: 'First internal view',
    required: true,
  },
  {
    key: 'internalCarcass2',
    label: 'Internal carcass 2',
    hint: 'Second internal view',
    required: true,
  },
  {
    key: 'treadDepth1',
    label: 'Tread depth 1',
    hint: 'First tread depth reading',
    required: true,
  },
  {
    key: 'treadDepth2',
    label: 'Tread depth 2',
    hint: 'Second tread depth reading',
    required: true,
  },
  {
    key: 'treadDepth3',
    label: 'Tread depth 3',
    hint: 'Third tread depth reading',
    required: true,
  },
  {
    key: 'treadPattern',
